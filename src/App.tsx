  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 p-6">
        <nav className="backdrop-blur-lg bg-white/5 rounded-full px-8 py-4 mx-auto max-w-6xl border border-white/10">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className="md:hidden bg-white/10 hover:bg-white/20 backdrop-blur-sm border-0 cursor-pointer"
            >
              <Menu></Menu>
            </Button>
          </div>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 backdrop-blur-lg bg-black/30 rounded-2xl p-6 mx-auto max-w-sm border border-white/10 animate-fadeIn">
      ...
      >
        ...
        <div className="absolute inset-0 z-5">
          ...
          <div className="absolute bottom-32 left-16 w-1.5 h-1.5 bg-blue-300/50 rounded-full animate-pulse delay-1000"></div>
          <div className="absolute bottom-20 right-20 w-2 h-2 bg-white/30 rounded-full animate-ping delay-500"></div>
        </div>

        {/* Floating Badges */}
        <div className="absolute inset-0 z-5 pointer-events-none">
          {/* Top Left Badge */}
          <div className="absolute top-24 left-12 transform -rotate-12 animate-bounce delay-300">
            <div className="bg-gradient-to-r from-blue-500/20 to-purple-600/20 backdrop-blur-md border border-white/20 rounded-lg px-3 py-2 text-xs font-medium">
              ✨ 4K Quality
            </div>
          </div>

          {/* Top Right Badge */}
          <div className="absolute top-32 right-16 transform rotate-6 animate-bounce delay-700">
            <div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-md border border-white/20 rounded-lg px-3 py-2 text-xs font-medium">
              🏆 Award Winner
            </div>
          </div>

          {/* Middle Left Badge */}
          <div className="absolute top-1/2 left-8 transform -translate-y-1/2 rotate-12 animate-bounce delay-1000">
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-md border border-white/20 rounded-lg px-3 py-2 text-xs font-medium">
              ⚡ Fast Delivery
            </div>
          </div>

          {/* Middle Right Badge */}
          <div className="absolute top-1/3 right-12 transform -rotate-6 animate-bounce delay-500">
            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 backdrop-blur-md border border-white/20 rounded-lg px-3 py-2 text-xs font-medium">
              🎬 Cinema Grade
            </div>
          </div>

          {/* Bottom Left Badge */}
          <div className="absolute bottom-40 left-20 transform rotate-6 animate-bounce delay-1200">
            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 backdrop-blur-md border border-white/20 rounded-lg px-3 py-2 text-xs font-medium">
              💎 Premium Effects
            </div>
          </div>

          {/* Bottom Right Badge */}
          <div className="absolute bottom-32 right-24 transform -rotate-12 animate-bounce delay-900">
            <div className="bg-gradient-to-r from-red-500/20 to-pink-500/20 backdrop-blur-md border border-white/20 rounded-lg px-3 py-2 text-xs font-medium">
              🔥 Viral Ready
            </div>
          </div>
        </div>
        ...
        {/* Main Content */}
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center space-y-8 flex flex-col items-center justify-center">
          {/* Enhanced Badge */}
          <div className="group border border-white/30 bg-white/5 backdrop-blur-md text-white text-sm py-2 px-6 rounded-full hover:bg-white/10 transition-all duration-300 hover:scale-105 flex items-center gap-3 cursor-pointer">
            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
            <VideoIcon className="w-4 h-4" />
            <span className="font-medium">Professional Video Editor</span>
          ...
          <div className="flex flex-wrap justify-center gap-8 text-center">
            ...
            <div className="space-y-1">
              <div className="text-2xl font-bold text-purple-400">24hr</div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button className="group px-8 py-4 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-bold hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25 flex items-center gap-2 justify-center">
            ...
            <button className="group px-8 py-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold hover:bg-white/20 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 justify-center">
          ...
          {/* Trust Indicators */}
          <div className="pt-8 flex flex-wrap justify-center items-center gap-6 text-white/60 text-sm">
      ...
      <section ref={portfolioRef} className="py-20 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div>
            ...
            <Button variant={"link"} className="pt-8 cursor-pointer text-white">
              <a
          ...
          <div className="mt-20">
            ...
            {/* CHROMA KEY SECTION */}
            <div>
              <h3 className="text-3xl lg:text-4xl font-bold mb-4 text-right">
            ...
            {/* Creative Process */}
            <div className="backdrop-blur-lg bg-white/5 rounded-3xl p-8 lg:p-12 border border-white/10">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 transform hover:scale-105"
              >
                <div className="mb-4">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">emmanueladewuyi3@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 rounded-full bg-blue-600/20 flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">+234 701 852 4281</p>
                    <p className="text-white/70">+234 810 324 6538</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 rounded-full bg-blue-600/20 flex items-center justify-center">
