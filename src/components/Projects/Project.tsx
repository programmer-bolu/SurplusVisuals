...
const Projects: React.FC = () => {
  ...
  return (
    <div className="py-[1rem] relative bg-gradient-to-b from-[#211F2E] to-[#0f0d13]">
      <div className="h2 px-[8rem]">
        <div>
            ...
            <div className="mx-auto">
              ...
              {visibleProjects < projects.length && (
                <div className="text-center mt-8 flex items-center justify-center">
                  <button
                    onClick={loadMore}
                    className="bg-primary text-white py-2 px-6 rounded-lg hover:bg-secondary transition-colors border border-white/50 cursor-pointer flex items-center justify-between"
                  >
                    Load More
                    <ChevronDown height={15}></ChevronDown>
                  </button>
                </div>
              )}
            </div>
