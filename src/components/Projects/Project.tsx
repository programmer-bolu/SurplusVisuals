...
const Projects: React.FC = () => {
  return (
    <div className="py-[8rem] relative bg-gradient-to-b from-[#211F2E] to-[#0f0d13]">
      <div className="h2 px-[8rem]">
        <div>
          <h2 className="text-[2rem] font-bold text-center">About Me</h2>
        </div>
        <div className="flex ">
          <div className="w-1/2 text-[1.5rem] font-medium">
